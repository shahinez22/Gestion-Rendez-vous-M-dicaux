<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-800">{{ $medecinsCount }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-800">{{ $patientsCount }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-800">{{ $rendezVousCount }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">Derniers Rendez-vous</h3>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($rendezVous as $rdv)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4">{{ $rdv->medecin->nom }}</td>
                                            <td class="px-6 py-4">{{ $rdv->patient->nom }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
